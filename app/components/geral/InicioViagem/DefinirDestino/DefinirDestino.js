...
export default function DefinirDestino({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.titulo}>Escolha o destino</Text>
            <TextInput
                style={styles.input}
            ...
            <Button
                ...
                onPress={() => navigation.navigate('Hubopcoes', { destino: address, coordenadas: marker })}
